        ...
        return [
            ...
            { 
                ...
                childNodes: [
                    {
                        nodeName: '#text',
                        value: `window.$corrosion = new Corrosion({ window, codec: '${this.ctx.config.codec || 'plain'}',  prefix: '${this.ctx.prefix}', ws: ${this.ctx.config.ws}, cookie: ${this.ctx.config.cookie}, }); $corrosion.init(); document.currentScript.remove();`
                    },
                ], 
                attrs: [],
            }
