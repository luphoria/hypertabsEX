...
class Corrosion extends require('../rewrite') {
    ...
    get parent() {
        ...
        try {
            return this.window.parent.$ht ? this.window.parent : this.window;
        } catch(e) {
            return this.window;
        };
    };
    get top() {
        if (this.serviceWorker) return false;
        try {
            return this.window.top.$ht ? this.window.top : this.parent;
        } catch(e) {
            return this.parent;
        };
    };
    init() {
        ...
        this.window.$htGet$ = this.get$.bind(this);
        this.window.$htSet$ = this.set$.bind(this);
        this.window.$htGet$m = this.get$m.bind(this);
        this.window.$htSet$m = this.set$m.bind(this);
        this.window.$htCall$m = this.call$m.bind(this);
    };
    get$m(obj, key) {
        if (!this.serviceWorker && this.window != this.window.parent && obj == this.window.parent) {
            return this.parent.$ht.get$m(this.parent, key);
        };
        if (!this.serviceWorker && this.window != this.window.top && obj == this.window.top) {
            return this.top.$ht.get$m(this.top, key);
        };
    ...
    set$m(obj, key, val, operator) {
        if (!this.serviceWorker && this.window != this.window.parent && obj == this.window.parent) {
            return this.parent.$ht.set$m(this.parent, key, val, operator);
        };
        if (!this.serviceWorker && this.window != this.window.top && obj == this.window.top) {
            return this.top.$ht.set$m(this.top, key, val, operator);
        };
    ...
    call$m(obj, key, args) {
        if (!this.serviceWorker && this.window != this.window.parent && obj == this.window.parent) {
            return this.parent.$ht.call$m(this.parent, key, args);
        };
        if (!this.serviceWorker && this.window != this.window.top && obj == this.window.top) {
            return this.top.$ht.call$m(this.top, key, args);
        };
        return obj[key](...args);
    };
    get$(obj) {
